...
function StatsTransactionPage() {
  ...
  const [start_at, setStartAt] = useState(moment().add(-1, 'days').format('YYYY-MM-DD HH:mm:ss'))
  ...
  const todayPaidSingle = () => {
    ...
    const value: any = list.today_paid_sum / list.today_paid_user_count
  ...
  const yesterdayPaidSingle = () => {
    ...
    const value: any = list.yesterday_paid_sum / list.yesterday_paid_user_count
  ...
  const todayPaidConversion = () => {
    ...
    const value: any = (list.today_paid_count / list.today_count).toFixed(2)
  ...
  const yesterdayPaidConversion = () => {
    ...
    const value: any = (list.yesterday_paid_count / list.yesterday_count).toFixed(
      2,
    )
  ...
  const drawLineChart = (params: any) => {
    ...
    myChart.setOption({
      ...
      xAxis: {
        type: 'category',
        boundaryGap: false,
        data: changeObjectKey(params.orderPayAmount),
      },
      yAxis: {
        type: 'value',
      },
      series: [
        {
          name: '支付金额',
          type: 'line',
          data: changeObject(params.orderPayAmount),
        },
        {
          name: '支付订单数',
          type: 'line',
          data: changeObject(params.orderPayCount),
        },
        {
          name: '支付人数',
          type: 'line',
          data: changeObject(params.orderPayNum),
        },
        {
          name: '客单均价',
          type: 'line',
          data: changeObject(params.orderPayAvg),
        },
      ],
    })
        ...
        <div className={styles.el_top_row1}>
          ...
          <div className={styles.el_row_item}>
            ...
            <div className={styles.item_info}>
              <span>
                昨日：
                {numberForHuman(list.yesterday_paid_count)}
              </span>
              <span>
                较昨日：
          ...
          <div className={styles.el_row_item2}>
            ...
            <div className={styles.el_item}>
              ...
              <span className={styles.el_item_increase}>
                昨日：
                {numberForHuman(list.yesterday_paid_user_count)}
              </span>
              <span className={styles.el_item_increase}>
                较昨日：
                {newSumrate(
            ...
            <div className={styles['data-box']}>
              <div className={styles['data-item']}>
                ...
                <div className={styles['info-t']}>
                  昨日：
                  {numberForHuman(list.yesterday_count)}
                </div>
