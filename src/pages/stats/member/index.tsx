...
function StatsMemberPage() {
  ...
  const sumrate = (num1: number, num2: number) => {
    ...
    const value: any = (num2 / (num1 - num2)).toFixed(2)
  ...
  const drawChart = (params: any) => {
    const num = params.first_count + params.non_first_count
    const data = [
      {
        name: '新成交学员',
        ...
        <div className={styles.el_top_row1}>
          <div className={styles.el_row_item}>
            ...
            <div className={styles.item_info}>
              <span>
                昨日：
                {numberForHuman(list.yesterday_watch_count)}
              </span>
              <span>
                较昨日：
                {newSumrate(
