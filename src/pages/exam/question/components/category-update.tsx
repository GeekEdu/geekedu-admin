...
export function CategoryUpdateDialog(props: PropsInterface) {
  ...
  const getDetail = async () => {
    const res: any = await question.categoryDetail(props.id, { type: 'QUESTIONS' })
    form.setFieldsValue({
      name: res.data.name,
      sort: res.data.sort,
  ...
  const onFinish = (values: any) => {
    ...
    question
      .categoryUpdate(props.id, updateValue)
      .then((res: any) => {
        setLoading(false)
        message.success('成功！')
        props.onSuccess()
