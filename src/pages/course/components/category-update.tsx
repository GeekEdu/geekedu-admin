...
export function CourseCategoryUpdateDialog(props: PropsInterface) {
  ...
  const getDetail = async () => {
    ...
    const res: any = await course.categoryDetail(reqParams)
    form.setFieldsValue({
      name: res.data.name,
      sort: res.data.sort,
  ...
  const onFinish = (values: any) => {
    ...
    course
      .categoryUpdate(props.id, updatedValues)
      .then((res: any) => {
        setLoading(false)
        message.success('成功！')
        props.onSuccess()
