...
export function MemberUpdateDialog(props: PropsInterface) {
  ...
  const getDetail = async () => {
    ...
    form.setFieldsValue({
      ...
      role_expired_at:
        res.data.vipId === 0
          ? ''
          : dayjs(res.data.vipExpireTime, 'YYYY-MM-DD HH:mm:ss'),
      role_id: res.data.vipId === 0 ? [] : res.data.vipId,
    })
    setRoleId(res.data.vipId === 0 ? null : res.data.vipId)
